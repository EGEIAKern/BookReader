...
class ExportServiceTests(unittest.TestCase):
    ...
    def test_export_creates_csv(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            saved_path = export_books_to_csv(books, file_path)
            ...
            self.assertEqual(rows[1][0], "Test Book")

    def test_export_creates_xlsx_when_openpyxl_available(self):
        try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            file_path = Path(temp_dir) / "library"
            saved_path = export_books_to_excel(books, file_path)
